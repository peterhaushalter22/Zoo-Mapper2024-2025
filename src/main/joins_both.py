...
class Joins_Page_Both(tk.Frame):
	def __init__(self, parent, controller):
		...
		label = tk.Label(self, text="Both Data Join", font=("Segoe UI", 36, "bold"), bg="white", fg="#333333", image=self.icon, compound="left", padx=10)    # Creates the title of the web page
